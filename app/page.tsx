...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Главный баннер */}
      <section className="relative h-[75vh] flex items-center justify-center bg-gradient-to-r from-blue-900 to-blue-700 wave-divider">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          <h1 className="text-hero text-3xl md:text-6xl mb-6 leading-tight">
            Найди свой <span className="text-accent">идеальный автомобиль</span> надежным способом
          </h1>
          <p className="text-lg md:text-2xl mb-8 text-gray-100 font-medium leading-relaxed">
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="container px-4">
          <div className="text-center mb-16">
            <h2 className="text-hero text-4xl md:text-5xl text-gray-900 mb-6">
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-t-[50px] mx-4 mt-8">
        <div className="container px-4">
